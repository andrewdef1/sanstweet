...
<?php 
	...
	<!-- PROSES Crawling-->
<button style="float: left; margin-top:0px;" type="submit" name="crawling" value="crawling" class="btn btn-primary">PROSES CRAWLING TWEET</button>
<?php
    if(isset($_POST['crawling'])){
     $NBk=new functest();
    //$NBc->bobotbayestraining($konek);
    $NBk->crawltesting($konek);
		?>
                                        <script type="text/javascript">
                                            alert('Tweet berhasil di crawling');
